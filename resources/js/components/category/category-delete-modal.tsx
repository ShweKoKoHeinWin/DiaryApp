                    ...
                    <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                        <div className="bg-white dark:bg-gray-900 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div className="border-b border-gray-900/10 pb-12 text-center">
                                <h2 className="text-base/7 font-semibold text-gray-900 dark:text-gray-200">Delete Category</h2>

                                <p className="text-sm font-semibold text-gray-700 dark:text-gray-400">Are you sure to delete this category ({category.name})?</p>
                            </div>
                        </div>
